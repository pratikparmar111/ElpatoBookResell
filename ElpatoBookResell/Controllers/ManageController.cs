...
namespace MVCManukauTech.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            premiumUsersCheck= premiumUsersCheck.Where(p => p.userID.ToString() == User.Identity.GetUserId()).OrderByDescending(p =>p.endDate).ToList();
            ...
            {   
                ...
                {
                    ViewBag.Message_Prime = "E";
                    ViewBag.Message_PrimeDate = premiumUsersCheck[0].endDate.ToString("dd-MMM-yyyy");
                    ...
                    //  string primeStatus = Session["primeStatus"] as string;
                }
                else
                {
            ...
            {
                //this is handled in front part 
            }
            //first check if prime member or not 
            return View(model);
        }
        public string SetprimeStatusShown()
        {
            //ref for session val
            //https://stackoverflow.com/questions/14138872/how-to-use-sessions-in-an-asp-net-mvc-4-application
            Session["primeStatusShown"] = "Yes";
            return "DoneSet";
        }
        public ActionResult ShopPrime()
        {
            
            premiumUser premiumUser1 = new premiumUser();
            premiumUser1.userID = User.Identity.GetUserId();
            premiumUser1.endDate = DateTime.Now.AddYears(1);//to make end date 1 year after purchase date
            db.premiumUsers.Add(premiumUser1);
            db.SaveChanges();
            ViewBag.Message = "Your Payment of $29.99 is successful";
            //add prime 
            Session["primeStatus"] = "Y";
            return View(premiumUser1);
        }
        //
